//! Parser-owned data model for a parsed JavaScript external library.
//!
...
impl ParsedJsLibrary {
    /// Creates an empty parsed library with no symbols and no diagnostics.
    pub fn empty() -> Self {
        Self {
