...
//! WHY: current compiler-integrated Beandown scope support is built from header/facade data. A
//! public conversion for arbitrary folded caller constants needs a separate design so this API
//! remains narrow instead of leaking frontend internals.
