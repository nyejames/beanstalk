//! Exec IR type definitions.
//!
//! WHAT: defines the runtime-oriented IR types executed by the Rust interpreter.
//! WHY: the interpreter should lower from HIR into a semantic execution format, not reuse Wasm-shaped LIR.

use super::instructions::{ExecInstruction, ExecTerminator};
