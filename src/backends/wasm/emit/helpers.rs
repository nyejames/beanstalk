...
pub(crate) fn emit_helper_function(
    ...
    let mut function = match helper {
        ...
        WasmRuntimeHelper::VecLen => Function::new(Vec::new()),
        WasmRuntimeHelper::VecGet => Function::new(Vec::new()),
    ...
    match helper {
        ...
        WasmRuntimeHelper::VecPushHandle => {
            // Vec layout (12 bytes):
            //   offset 0: data_ptr  (i32) — pointer to contiguous i32 handle array
            //   offset 4: len       (i32) — logical element count
            //   offset 8: capacity  (i32) — allocated element capacity
            const VEC_HANDLE: u32 = 0;
