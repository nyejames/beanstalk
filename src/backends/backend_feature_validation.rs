...
use crate::compiler_frontend::hir::reachability::{
    ReachableMapUse, ReachableMapUseKind, collect_reachability_from_start,
};
...
///
/// WHAT: hashmap construction/use is legal HIR, but only the JS backend lowers it for Alpha.
