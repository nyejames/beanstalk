...
/// Integration test for print statement functionality
/// This test requires a valid WASM module with print statements
#[test]
#[ignore] // Ignored until we have valid WASM modules to test with
fn test_print_statement_integration() {
    // This test would require a real WASM module generated by the Beanstalk compiler
    // with print statements to test the full integration
    
    // Example of what this test would do:
    // 1. Compile a Beanstalk program with print statements
    ...
    println!("Print statement integration test - requires valid WASM modules");
}
