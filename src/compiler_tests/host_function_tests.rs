...
mod host_function_registry_tests {
    ...
    fn test_host_function_registration() {
        ...
        registry.register_function(test_function).expect("Failed to register function");
        
        // Verify registration
        assert_eq!(registry.count(), 1);
        assert!(registry.has_function("test_func"));
        
        let retrieved = registry.get_function("test_func").expect("Function should exist");
    ...
    fn test_duplicate_function_registration() {
        ...
        registry.register_function(test_function1).expect("First registration should succeed");
    ...
    fn test_registry_validation() {
        ...
        for function in registry.list_functions() {
            ...
            assert!(matches!(function.module.as_str(), "beanstalk_io" | "beanstalk_env" | "beanstalk_sys"));
        }
    }
}
...
mod host_function_ast_tests {
    ...
    fn test_ast_integration_placeholder() {
        ...
        assert!(registry.has_function("print"), "Registry should have print function");
...
mod host_function_wir_tests {
    ...
    fn test_wasm_import_information() {
        ...
        assert_eq!(print_func.module, "beanstalk_io");
        assert!(matches!(print_func.module.as_str(), "beanstalk_io" | "beanstalk_env" | "beanstalk_sys"));
...
mod host_function_error_tests {
    ...
    fn test_parameter_validation() {
        ...
        assert!(result.is_err(), "Should reject function with invalid parameter name");
    }
}
