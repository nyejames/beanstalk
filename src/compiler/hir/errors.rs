...
//!
//! ```rust
//! use crate::compiler::hir::errors::{HirError, HirErrorKind, HirErrorContext};
//!
...
impl From<HirError> for CompilerError {
    fn from(error: HirError) -> Self {
        ...
        // Determine error type based on whether this is a compiler bug
...
macro_rules! hir_transform_failed {
    ($node_type:expr, $reason:expr, $location:expr) => {
        $crate::compiler::hir::errors::HirError::transformation(
            $crate::compiler::hir::errors::HirErrorKind::TransformationFailed {
...
/// Creates an HIR internal error (compiler bug)
#[macro_export]
macro_rules! hir_internal_error {
    ($msg:expr) => {
        $crate::compiler::hir::errors::HirError::new(
            $crate::compiler::hir::errors::HirErrorKind::InternalError($msg.to_string()),
    ...
    ($fmt:expr, $($arg:tt)*) => {
        $crate::compiler::hir::errors::HirError::new(
            $crate::compiler::hir::errors::HirErrorKind::InternalError(format!($fmt, $($arg)*)),
            $crate::compiler::compiler_errors::ErrorLocation::default(),
            $crate::compiler::hir::errors::HirErrorContext::default(),
        )
        .with_suggestion("This is a compiler bug - please report it")
