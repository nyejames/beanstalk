...
use crate::compiler::hir::nodes::{HirBlock, HirKind, HirModule, HirStmt};
use crate::compiler::lir::nodes::{LirFunction, LirModule, LirStruct};
...
fn lower_function(
    ...
    body: crate::compiler::hir::nodes::BlockId,
    blocks: &[HirBlock],
    is_main: bool,
