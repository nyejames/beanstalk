...
impl InstructionLowerer {
    ...
    pub fn lower_block(
        ...
        function: &mut Function,
        control_flow: &mut crate::compiler::codegen::wasm::control_flow::ControlFlowManager,
    ) -> Result<(), CompilerError> {
    ...
    pub fn lower_possible_drop(
        ...
        local: u32,
        function: &mut Function,
        ownership_manager: &crate::compiler::codegen::wasm::ownership_manager::OwnershipManager,
    ) -> Result<(), CompilerError> {
        let wasm_local = self
            .get_wasm_local(local)
            .map_err(|e| e.to_compiler_error(ErrorLocation::default()))?;
