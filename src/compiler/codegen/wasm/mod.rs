...
//!
//! ```rust,ignore
//! use beanstalk::compiler::codegen::wasm::encode::encode_wasm;
//! use beanstalk::compiler::lir::nodes::{LirFunction, LirInst, LirModule, LirType};
//!
...
//!
//! ### Possible Drop
//! The compiler inserts `possible_drop()` operations at control flow boundaries.
