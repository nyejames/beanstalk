...
use crate::compiler_frontend::compiler_messages::{
    CompileTimeEvaluationErrorReason, DiagnosticPayload, InvalidCallShapeReason,
};
...
fn build_project_rejects_const_record_with_non_constant_argument() {
    ...
    .expect("should write source file");
    {
        ...
        assert!(
            ...
            "expected a targeted error describing the non-constant argument, got: {:?}",
            messages
                .error_diagnostics()
        ...
        assert!(
            messages.error_diagnostics().any(|diagnostic| matches!(
                ...
                DiagnosticPayload::InvalidCallShape {
                    reason: InvalidCallShapeReason::MissingArgument { .. },
                    ..
                }
            )),
    ...
    .expect("should write source file");
    {
        ...
        assert!(
            messages.error_diagnostics().any(|diagnostic| matches!(
                &diagnostic.payload,
                DiagnosticPayload::InvalidCallShape {
                    reason: InvalidCallShapeReason::ExtraPositionalArgument { .. },
                    ..
                }
            )),
