...
// These can be thought of as communicating with the build system, compiler_frontend or host environment.
// They are a flexible way to extend complex behaviours in the compiler_frontend or for build systems to be able to provide special commands.
...
pub fn compiler_directive(
    ...
    loop {
        ...
        match token_value.as_str() {
            ...
            _ => {
                return_syntax_error!(
                    format!("Invalid compiler_frontend directive: #{}", token_value),
