...
pub(crate) use diagnostic_payload::{
    ...
    InvalidLibraryFolderReason, InvalidLoopHeaderReason, InvalidMapLiteralReason,
    InvalidMapTypeReason, InvalidMatchArmReason, InvalidMatchPatternReason, InvalidMultiBindReason,
