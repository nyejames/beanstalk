...
//! Integrates with the existing compiler_frontend error system to provide consistent error formatting.

use super::{
    borrow_state::{BorrowConflict, BorrowKind, ConflictType},
    place_registry::{Place, PlaceId, PlaceRegistry},
};
use crate::compiler_frontend::compiler_errors::ErrorType::BorrowChecker;
