...
const RESERVED_KEYWORD_SHADOWS: [&str; 33] = [
    "import", "if", "case", "return", "yield", "else", "block", "checked", "async", "as", "copy",
    "type", "of", "must", "this", "loop", "to", "by", "break", "continue", "is", "not", "and",
    "or", "true", "false", "none", "fn", "float", "int", "string", "bool", "char",
];
