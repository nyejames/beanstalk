//! Result-call suffix parsing implementation.
//!
...
use super::fallback::result_success_types;
use super::named_handler::{
    NamedResultHandler, NamedResultHandlerSite, parse_named_result_handler,
};
use super::{
    EXPRESSION_STAGE, FUNCTION_CALL_STAGE, is_result_propagation_boundary,
