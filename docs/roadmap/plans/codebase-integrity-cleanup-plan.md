...
STATUS: proposed
AUDIT_ANCHOR: a688cc3be9f2eda49586d298a0fff7f3b4ffcf84
AUDITED_BRANCH: main
SEQUENCE: begin after docs/roadmap/plans/final-tir-completion-plan.md closes
TIR_OVERLAP: none
```

Before implementation, refresh every named file against current `main`. Keep a finding only when the same failure mode still exists.
